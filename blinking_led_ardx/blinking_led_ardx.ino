...
//LED Pin Variables
int ledPins[] = {2,3,4,5,6,7,8,9,10}; //An array to hold the pin each LED is connected to
...
void oneAfterAnotherNoLoop(){
  ...
  delay(delayTime);                //waits delayTime milliseconds  
  digitalWrite(ledPins[8], HIGH);  //Turns on LED #7 (connected to pin 9 )
  delay(delayTime);                //waits delayTime milliseconds  
  
//Turns Each LED Off
  digitalWrite(ledPins[8], LOW);  //Turns on LED #7 (connected to pin 9 )
  delay(delayTime);                //waits delayTime milliseconds  
